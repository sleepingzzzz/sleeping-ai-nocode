...
import com.sleeping.ainocode.model.dto.app.AppAddRequest;
import com.sleeping.ainocode.model.dto.app.AppAdminUpdateRequest;
import com.sleeping.ainocode.model.dto.app.AppQueryRequest;
import com.sleeping.ainocode.model.dto.app.AppUpdateRequest;
...
public class AppController {
    ...
    public BaseResponse<Long> addApp(@RequestBody AppAddRequest appAddRequest, HttpServletRequest request) {
        ...
        App app = new App();
        app.setInitPrompt(SanitizeUtils.sanitizePreserveBasic(initPrompt));
    ...
    public BaseResponse<Boolean> updateApp(@RequestBody AppUpdateRequest appUpdateRequest, HttpServletRequest request) {
        ...
        App app = new App();
        app.setId(id);
        app.setAppName(SanitizeUtils.sanitizePreserveBasic(appUpdateRequest.getAppName()));
    ...
    public BaseResponse<Boolean> updateAppByAdmin(@RequestBody AppAdminUpdateRequest appAdminUpdateRequest) {
        ...
        app.setAppName(SanitizeUtils.sanitizePreserveBasic(app.getAppName()));
        app.setCover(SanitizeUtils.sanitizePreserveBasic(app.getCover()));
        app.setEditTime(LocalDateTime.now());
        boolean result = appService.updateById(app);
        ThrowUtils.throwIf(!result, ErrorCode.OPERATION_ERROR);
        return ResultUtils.success(true);
